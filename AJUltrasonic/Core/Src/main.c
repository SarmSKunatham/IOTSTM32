...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  // Distance in range of object detected
...
//		  speed = 600;
		  ...
		  if (mode == 0) {
			  ...
			  // Servo move to 0
			  TIM3->CCR1 = 25;  // duty cycle is .5 ms 0
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED3_Pin|GPIO_PIN_5|DC1_Pin|Trig_Pin
  ...
  /*Configure GPIO pins : LED3_Pin PA5 DC1_Pin Trig_Pin
                           LED1_Pin */
  GPIO_InitStruct.Pin = LED3_Pin|GPIO_PIN_5|DC1_Pin|Trig_Pin
                          |LED1_Pin;
